...
export default function Module1RenewablesDashboard() {
  ...
  const ui = {
    ...
    ru: {
      intro: 'В этой модели изучите влияние возобновляемых источников на глобальную температуру (помните цель 1,5°C!) и другие эффекты, которые можно выбрать в выпадающем списке графика.',
      choose: 'Вы можете выбрать:',
      statusTitle: 'Статус‑кво:',
      statusText: 'Сохранить текущий уровень использования возобновляемой энергии. С этого значения начинается ползунок.',
      encourageTitle: 'Поощрять:',
      encourageText: 'Поддерживать строительство и использование солнечных панелей, геотермии и ветровых турбин через государственные субсидии, позволяющие инвестировать в ВИЭ и снижать затраты для потребителей.',
      discourageTitle: 'Сдерживать:',
      discourageText: 'Через налоги, повышающие стоимость инвестиций и использования ВИЭ, а также через политику или коммуникации.',
      dashboardTitle: 'Панель En‑ROADS: Возобновляемая энергия',
      ...
      seaLevelRise: 'Повышение уровня моря',
      deathsExtremeHeat: 'Смерти от экстремальной жары',
      speciesLoss: 'Потеря видов — вымирание',
      cropYield: 'Урожайность',
      airPollution: 'Загрязнение воздуха',
      marineSpecies: 'МОРСКИЕ ВИДЫ',
      landSpecies: 'НАЗЕМНЫЕ ВИДЫ',
      dashedBaseline: 'Пунктирные линии обозначают базовый сценарий',
      temperatureTitle: 'Увеличение\nтемпературы\nк 2100 году',
      renewablesLabel: 'Возобновляемая энергия',
      highlyDiscouraged: 'Сильно сдерживать',
      discouraged: 'Сдерживать',
      statusQuo: 'Статус‑кво',
      moreEncouraged: 'Больше поощрять',
      highlyEncouraged: 'Сильно поощрять',
      loadingModel: 'Загрузка модели...',
      failedToLoad: 'Не удалось загрузить модель En-ROADS.',
    },
    uk: {
      intro: 'У цій моделі досліджуй вплив відновлюваних джерел на глобальну температуру (пам’ятай про ціль 1,5°C!) та інші впливи, які можна вибрати у випадаючому списку графіка.',
      choose: 'Ви можете обрати:',
      statusTitle: 'Статус‑кво:',
      statusText: 'Зберегти поточний рівень використання відновлюваної енергії. З цього значення починається повзунок.',
      encourageTitle: 'Заохочувати:',
      encourageText: 'Підтримувати будівництво та використання сонячних панелей, геотермії й вітрових турбін через державні субсидії, що дозволяють інвестувати у ВДЕ та знижувати витрати для споживачів.',
      discourageTitle: 'Стримувати:',
      discourageText: 'Через податки, що підвищують вартість інвестицій і використання ВДЕ, через політику або комунікації.',
      dashboardTitle: 'Панель En‑ROADS: Відновлювана енергія',
      ...
      seaLevelRise: 'Підвищення рівня моря',
      deathsExtremeHeat: 'Смерті від екстремальної спеки',
      speciesLoss: 'Втрата видів — вимирання',
      cropYield: 'Урожайність',
      airPollution: 'Забруднення повітря',
      marineSpecies: 'МОРСЬКІ ВИДИ',
      landSpecies: 'НАЗЕМНІ ВИДИ',
      dashedBaseline: 'Пунктирні лінії показують базовий сценарій',
      temperatureTitle: 'Зростання\nтемператури\nдо 2100 року',
      renewablesLabel: 'Відновлювана енергія',
      highlyDiscouraged: 'Сильно стримувати',
      discouraged: 'Стримувати',
      statusQuo: 'Статус‑кво',
      moreEncouraged: 'Більше заохочувати',
      highlyEncouraged: 'Сильно заохочувати',
      loadingModel: 'Завантаження моделі...',
      failedToLoad: 'Не вдалося завантажити модель En-ROADS.',
    },
    da: {
      intro: 'I denne model kan du udforske, hvordan vedvarende energi påvirker den globale temperatur (husk målet på 1,5°C!) og andre effekter, som du kan vælge i grafens dropdown.',
      choose: 'Du kan vælge:',
      statusTitle: 'Status quo:',
      statusText: 'Bevar de nuværende niveauer af brug af vedvarende energi. Det er her skyderen starter.',
      encourageTitle: 'Fremme:',
      encourageText: 'Støt opbygning og brug af solpaneler, geotermi og vindmøller gennem offentlige tilskud, som gør investering i vedvarende energi mulig og sænker omkostningerne for forbrugerne.',
      discourageTitle: 'Bremse:',
      discourageText: 'Gennem afgifter, der hæver omkostningerne ved investering i og brug af vedvarende energi, via politik eller kommunikation.',
      dashboardTitle: 'En-ROADS Dashboard: Vedvarende energi',
      openFullscreen: 'Åbn i fuld skærm',
      closeFullscreen: 'Luk fuld skærm',
      baseline: 'BASELINE',
      currentScenario: 'NUVÆRENDE SCENARIE',
      co2Emissions: 'CO2-udledninger',
      seaLevelRise: 'Havniveau-stigning',
      deathsExtremeHeat: 'Dødsfald fra ekstrem varme',
      speciesLoss: 'Tab af arter – uddøen',
      cropYield: 'Udbytte af afgrøder',
      airPollution: 'Luftforurening',
      marineSpecies: 'MARINE ARTER',
      landSpecies: 'LANDARTER',
      dashedBaseline: 'Stiplede linjer viser baseline',
      temperatureTitle: 'Temperatur-\nstigning\ni 2100',
      renewablesLabel: 'Vedvarende',
      highlyDiscouraged: 'Stærkt bremset',
      discouraged: 'Bremset',
      statusQuo: 'Status quo',
      moreEncouraged: 'Mere fremmet',
      highlyEncouraged: 'Stærkt fremmet',
      loadingModel: 'Indlæser model...',
      failedToLoad: 'Kunne ikke indlæse En-ROADS-model.',
    },
    ar: {
      intro: 'في هذا النموذج، استكشف تأثير الطاقة المتجددة على درجة الحرارة العالمية (تذكّر هدفنا 1.5°م!) وعلى آثار أخرى يمكنك اختيارها من القائمة المنسدلة للرسم.',
      choose: 'يمكنك الاختيار:',
      statusTitle: 'الوضع القائم:',
      statusText: 'الحفاظ على المستويات الحالية لاستخدام الطاقة المتجددة. من هنا يبدأ شريط التمرير.',
      encourageTitle: 'تشجيع:',
      encourageText: 'دعم بناء واستخدام الألواح الشمسية والطاقة الحرارية الأرضية وتوربينات الرياح عبر إعانات حكومية تتيح الاستثمار في الطاقة المتجددة وتخفّض التكاليف على المستهلكين.',
      discourageTitle: 'تثبيط:',
      discourageText: 'عبر الضرائب التي ترفع تكاليف الاستثمار في الطاقة المتجددة واستخدامها، ومن خلال السياسات أو التواصل.',
      dashboardTitle: 'لوحة En‑ROADS: الطاقة المتجددة',
      openFullscreen: 'فتح ملء الشاشة',
      closeFullscreen: 'إغلاق ملء الشاشة',
      baseline: 'خط الأساس',
      currentScenario: 'السيناريو الحالي',
      co2Emissions: 'انبعاثات CO2',
      seaLevelRise: 'ارتفاع مستوى سطح البحر',
      deathsExtremeHeat: 'وفيات بسبب الحرارة الشديدة',
      speciesLoss: 'فقدان الأنواع — الانقراض',
      cropYield: 'غلة المحاصيل',
      airPollution: 'تلوث الهواء',
      marineSpecies: 'أنواع بحرية',
      landSpecies: 'أنواع برية',
      dashedBaseline: 'تمثل الخطوط المتقطعة خط الأساس',
      temperatureTitle: 'زيادة\nدرجة الحرارة\nبحلول 2100',
      renewablesLabel: 'الطاقة المتجددة',
      highlyDiscouraged: 'مثبَّط بشدة',
      discouraged: 'مثبَّط',
      statusQuo: 'الوضع القائم',
      moreEncouraged: 'تشجيع أكثر',
      highlyEncouraged: 'تشجيع شديد',
