...
export default function Module1CarbonPriceDashboard() {
  ...
  const ui = {
    ...
    ru: {
      ...
      cropYield: 'Снижение урожайности из‑за потепления',
    ...
    uk: {
      ...
      cropYield: 'Зниження врожайності через потепління',
      airPollution: 'Забруднення повітря',
    },
    da: {
      title: 'Byg en model: Kulstofpris',
      ...
      cropYield: 'Udbyttetab pga. opvarmning',
      airPollution: 'Luftforurening',
    },
    ar: {
      title: 'اصنع نموذجًا: سعر الكربون',
      ...
      cropYield: 'انخفاض غلة المحاصيل بسبب الاحترار',
