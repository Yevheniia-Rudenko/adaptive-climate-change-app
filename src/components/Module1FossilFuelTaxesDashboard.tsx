...
export default function Module1FossilFuelTaxesDashboard() {
  ...
  const ui = {
    ...
    ru: {
      title: 'Панель En‑ROADS: Налоги на ископаемое топливо',
      ...
      taxOnCoal: 'Налог на уголь',
      taxOnOil: 'Налог на нефть',
      taxOnGas: 'Налог на газ',
      highlyDiscouraged: 'Сильно сдерживать',
      discouraged: 'Сдерживать',
      lessEncouraged: 'Меньше поощрять',
    ...
    uk: {
      title: 'Панель En‑ROADS: Податки на викопне паливо',
      ...
      taxOnCoal: 'Податок на вугілля',
      taxOnOil: 'Податок на нафту',
      taxOnGas: 'Податок на газ',
      highlyDiscouraged: 'Сильно стримувати',
      discouraged: 'Стримувати',
      lessEncouraged: 'Менше заохочувати',
      statusQuo: 'Статус‑кво',
      moreEncouraged: 'Більше заохочувати',
      encouraged: 'Заохочувати',
      highlyEncouraged: 'Сильно заохочувати',
    },
    da: {
      title: 'En-ROADS Dashboard: Afgifter på fossile brændsler',
      openFullscreen: 'Åbn i fuld skærm',
      closeFullscreen: 'Luk fuld skærm',
      temperatureTitle: 'Temperatur-\nstigning\ntil 2100',
      co2NetEmissions: 'Netto-CO2-udledninger',
      seaLevelRise: 'Havniveau-stigning',
      baseline: 'BASELINE',
      currentScenario: 'NUVÆRENDE SCENARIE',
      taxOnCoal: 'Afgift på kul',
      taxOnOil: 'Afgift på olie',
      taxOnGas: 'Afgift på gas',
      highlyDiscouraged: 'Stærkt bremset',
      discouraged: 'Bremset',
      lessEncouraged: 'Mindre fremmet',
      statusQuo: 'Status quo',
