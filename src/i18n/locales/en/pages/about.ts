export const about = {
  ...
  curriculumOverview: {
    ...
    p2: 'This curriculum also supports young people to learn about climate policies using En-ROADS, the climate policy simulator co-developed by Climate Interactive and MIT Sloan. En‑ROADS is a global climate simulator that lets you test how different climate solutions—like electrifying transportation, putting a price on carbon, or changing farming practices—affect things like temperature, air quality, sea level rise, and energy costs.',
  ...
  systemsAwarenessLab: {
    ...
    p1: 'Bringing together researchers, educators, policymakers, and practitioners dedicated to the study of systems change.',
    p2: 'At the MIT Systems Awareness Lab, our mission is to develop, investigate, and grow the conditions for greater human and planetary flourishing in response to the global poly-crisis, including the climate emergency, social inequities, and the youth mental health crisis.',
  ...
  viewContributors: 'View Our Contributors & Credits →'
};
