export const module4 = {
  ...
  sections: [
    ...
    {
      content: [
        { title: 'Top of the Iceberg: Events', content: '' },
        {
          alt: 'Systems Iceberg Model showing Events, Behavioral Patterns, Underlying Structures, Mental Models, and Artifacts',
    ...
    {
      content: [
        { title: 'Just Below the Surface: Behavioral Patterns', content: '' },
        {
          alt: 'Systems Iceberg Model showing Events, Behavioral Patterns, Underlying Structures, Mental Models, and Artifacts',
    ...
    {
      content: [
        { title: 'Why Think About Climate Systems Using the Iceberg Model?', content: '' },
    ...
    {
      content: [
        { title: '✏️ Draw Your Own Climate Iceberg', content: '' },
        {
          alt: 'Systems Iceberg Model showing Events, Behavioral Patterns, Underlying Structures, Mental Models, and Artifacts',
