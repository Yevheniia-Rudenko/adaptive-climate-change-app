  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        { question: '**Scenario 2. Drop Emissions**\nIf our total CO₂ emissions drop a lot and become much lower than they are today, and our CO₂ removals remain the same, what do you think will happen to the CO₂ concentration in the atmosphere?', options: ['Increase', 'Level out', 'Decrease'] } // 3: poll
      ]
    },
    {
